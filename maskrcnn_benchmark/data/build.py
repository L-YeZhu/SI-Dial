...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0):
    ...
    for dataset in datasets:
        #print('============')
        #print("check dataset",len(dataset))
        ...
        #for i, (img, tar, index, q, a) in enumerate(data_loader):
        #    print("--------",i)
        #    print("check loader", img, tar, index, q, a)
            #exit()
        #exit()
    ...
    if is_train:
        ...
        #print("check dataloader in training", data_loaders[0])
